...
const Navbarinfopagek = ({intro,female,male,inter,conc}) => {
    return (
      <nav className="flex flex-row w-screen overflow-x-hidden bg-[#e2b714] h-20 text-white text-lg font-bold sticky top-0 z-[10] gap-[19rem]">
...
export default Navbarinfopagek;
