...
const Navbarsafety = ({intro, conc, pb, kp}) => {
    return (
      <nav className="flex flex-row w-screen overflow-x-hidden bg-[#315729] h-20 text-white text-lg font-bold sticky top-0 z-[10] gap-[24rem]">
